...
<main>
    <section class="project">
        <div class="container">
            ...
            <project-pages-list :pages="pages" @remove="deletePage" @openSettings="openSettings"></project-pages-list>
        </div>
        <domain-modal v-if="isDomainOpen" @closeDomain="closeDomain"></domain-modal>
        <settings-modal v-if="isSettingsOpen" :page="pages[activeIndex]" @closeSettings="closeSettings" @saveTitle="saveTitle" @saveBadge="saveBadge"></settings-modal>
    </section>
</main>
</template>
